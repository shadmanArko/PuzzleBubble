...
namespace Bubble
{
    public class BubbleGraph : IDisposable
    {
        ...
        {
            _gameStateController.CurrentState = GameState.Loading;
            ...
            _gameStateController.CurrentState = GameState.WaitingToShoot;
        }
        ...
        private async UniTask CheckGameOverCondition()
        {
            ...
            {
                _gameStateController.CurrentState = GameState.GameOverWin;
            }

            else if (_isStrikerFinished)
            {
                _gameStateController.CurrentState = GameState.GameOverLose;
            }
            else
            {
                _gameStateController.CurrentState = GameState.WaitingToShoot;
